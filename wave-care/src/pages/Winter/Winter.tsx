...
const products = [
  ...
  {
    name: "Winter Nourish Conditioner",
    ...
    <div className={`${styles.container} ${poppins.variable} ${playfair.variable}`}>
      ...
      <section className={styles.productsSection}>
        ...
        <ProductCarousel
          ...
          products={products}
          bannerSrc="/products/inverno-produtos/propaganda-inverno.jpg"
